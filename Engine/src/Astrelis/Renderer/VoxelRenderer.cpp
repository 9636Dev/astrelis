...
namespace Astrelis
{
    ...
    void VoxelRenderer::Shutdown()
    {
        ...
        ASTRELIS_CORE_LOG_INFO("VoxelRenderer shutdown!");
    }
    ...
    {
        InternalBeginFrame();
        ASTRELIS_PROFILE_SCOPE("VoxelRenderer::BeginFrame");
    }

    void VoxelRenderer::EndFrame() { ASTRELIS_PROFILE_SCOPE("VoxelRenderer::EndFrame"); }
} // namespace Astrelis
