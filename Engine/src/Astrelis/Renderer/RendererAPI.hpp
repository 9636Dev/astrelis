...
namespace Astrelis {
    ...
    public:
        ...
        */
        ...
        static BufferingMode GetBufferingMode() {
            return s_BufferingMode;
        }

        static std::uint32_t GetBufferingCount() {
            return static_cast<std::uint32_t>(s_BufferingMode);
        }
        ...
        virtual void DrawInstanced(std::uint32_t vertexCount, std::uint32_t instanceCount,
