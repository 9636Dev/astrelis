...
#define ASTRELIS_CORE_LOG_FATAL(...) SPDLOG_LOGGER_CRITICAL(::Astrelis::Log::GetCoreLogger(), __VA_ARGS__)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define ASTRELIS_CORE_LOG_ERROR(...) SPDLOG_LOGGER_ERROR(::Astrelis::Log::GetCoreLogger(), __VA_ARGS__)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define ASTRELIS_CORE_LOG_WARN(...) SPDLOG_LOGGER_WARN(::Astrelis::Log::GetCoreLogger(), __VA_ARGS__)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define ASTRELIS_CORE_LOG_INFO(...) SPDLOG_LOGGER_INFO(::Astrelis::Log::GetCoreLogger(), __VA_ARGS__)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define ASTRELIS_CORE_LOG_DEBUG(...) SPDLOG_LOGGER_DEBUG(::Astrelis::Log::GetCoreLogger(), __VA_ARGS__)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define ASTRELIS_CORE_LOG_TRACE(...) SPDLOG_LOGGER_TRACE(::Astrelis::Log::GetCoreLogger(), __VA_ARGS__)

// Client log macros
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define ASTRELIS_LOG_FATAL(...) SPDLOG_LOGGER_CRITICAL(::Astrelis::Log::GetClientLogger(), __VA_ARGS__)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
