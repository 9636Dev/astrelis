...
namespace Nebula::Vulkan
{
    ...
    public:
        ...
        [[nodiscard]] bool Init(const RawRef<GLFWwindow*>& window, PhysicalDevice& physicalDevice, LogicalDevice& logicalDevice, Surface& surface, VkSwapchainKHR oldSwapchain = VK_NULL_HANDLE);
