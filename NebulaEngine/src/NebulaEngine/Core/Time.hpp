...
namespace Nebula
{
    ...
    public:
        ...
        explicit TimeSpan(const TimeSpan<T2, Ratio2>& other) : m_Duration(std::chrono::duration_cast<std::chrono::duration<T, Ratio>>(other.m_Duration)) {}
        ...
        template<typename T2, typename Ratio2>
        TimeSpan& operator=(TimeSpan<T2, Ratio2>&& other)
        {
            m_Duration = std::chrono::duration_cast<std::chrono::duration<T, Ratio>>(other.GetDuration());
            return *this;
        }
        ...
        {
            return TimeSpan(m_Duration + std::chrono::duration_cast<std::chrono::duration<T, Ratio>>(other.GetDuration()));
        }
        ...
        TimeSpan operator*(T2 scalar) const
        {
