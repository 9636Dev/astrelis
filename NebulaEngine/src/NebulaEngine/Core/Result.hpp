...
namespace Nebula
{
    ...
    public:
        ...
        Result(const ResultType& other) noexcept
            requires(std::is_nothrow_copy_constructible_v<T> && std::is_nothrow_copy_constructible_v<E>)
            : m_Value(other.m_Value)
        {
        }
        ...
        Result(ResultType&& other) noexcept
            requires(std::is_nothrow_move_constructible_v<T> && std::is_nothrow_move_constructible_v<E>)
            : m_Value(std::move(other.m_Value))
        {
        }
