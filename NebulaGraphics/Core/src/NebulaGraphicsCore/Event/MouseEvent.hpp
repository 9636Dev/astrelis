...
namespace Nebula {
    ...
    public:
        ...
        [[nodiscard]] constexpr std::uint32_t GetCategoryFlags() const noexcept override { return EventCategory::Mouse | EventCategory::Input; }
    ...
    public:
        ...
        [[nodiscard]] std::string ToString() const override {
            std::stringstream stream;
            stream << "MouseScrollEvent (Offset: " << m_OffsetX << ", " << m_OffsetY << ")";
            return stream.str();
        }
    ...
    public:
        ...
        [[nodiscard]] constexpr std::uint32_t GetCategoryFlags() const noexcept override { return EventCategory::Mouse | EventCategory::Input | EventCategory::MouseButton; }
    protected:
