...
namespace Nebula
{
    ...
    {
    public:
        static ResultSuccess<T, R> Ok(T value)
        {
            return ResultSuccess<T, R>(value);
        }

        static ResultError<T, R> Err(T value)
        {
            return ResultError<T, R>(value);
        }
    ...
    template<typename T, typename R>
    class ResultSuccess : public Result<T, R>
    {
    public:
        ...
        [[nodiscard]] T Unwrap() const override
        {
            return m_Value;
        }

        [[nodiscard]] R UnwrapError() const override
        {
            throw std::logic_error("Cannot unwrap error from success");
        }
    ...
    template<typename T, typename R>
    class ResultError : public Result<T, R>
    {
    public:
        ...
        [[nodiscard]] T Unwrap() const override
        {
            throw std::logic_error("Cannot unwrap value from error");
        }
